...
def _build_user_prompt(url: str, metrics: dict, cleaned_text: str) -> str:
    ...
    return (
        ...
        f"- Meta Title: {metrics['meta_title']} ({metrics.get('meta_title_length', 0)} chars)\n"
        f"- Meta Description: {metrics['meta_description']} ({metrics.get('meta_description_length', 0)} chars)\n"
        f"\n"
